...
export const FALLBACK_HOME_MODULES: PlatformModule[] = [
  ...
  { id: 11, key: 'rides', name: 'Rides', slug: 'rides', description: 'Book a safe ride', icon: 'car', color: '#2563EB', gradient: ['#2563EB', '#1D4ED8'], route: '/rides', isActive: true, availableOnWeb: true, availableOnMobile: true, sortOrder: 75 },
